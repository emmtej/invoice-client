...
import { createFolder } from "@/features/storage/folderQueries";
...
export function SaveToLibraryModal({
	...
	// For simplicity in this modal, we'll focus on folder counts.
	const rootCount = 0;
	...
	const handleCreateFolder = async () => {
		...
		try {
			...
			// We can use a ref or just watch the list.
			// But for now, we'll keep the scroll logic but use requestAnimationFrame or just effect.
		} finally {
